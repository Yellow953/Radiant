...
<div class="container">
    <h2 class="color-pink">Terms of Service</h2>

    <div class="my-5">
        <p>These Terms of Service ("Terms") govern your use of the Radiant.pod website (the "Service") operated by
            Radiant.pod ("us", "we", or "our"). Your access to and use of the Service is conditioned on your acceptance
            of
            and compliance with these Terms. These Terms apply to all visitors, users, and others who access or use the
            Service.</p>

        <h3 class="mt-5 mb-3 color-primary">Accounts</h3>
        ...
        <h3 class="mt-5 mb-3 color-primary">Purchases</h3>

        <p>If you wish to purchase any product or service made available through the Service ("Purchase"), you may be
            asked
            to supply certain information relevant to your Purchase including, without limitation, your credit card
            number,
            the expiration date of your credit card, your billing address, and your shipping information.</p>
        ...
        <p>By submitting such information, you grant us the right to provide the information to third parties for
            purposes
            of facilitating the completion of Purchases.</p>

        <h3 class="mt-5 mb-3 color-primary">Availability, Errors, and Inaccuracies</h3>
        ...
        <p>We are constantly updating our offerings of products and services on the Service. The products or services
            ...
            delays
            in updating information on the Service and in our advertising on other web sites.</p>
        ...
        <h3 class="mt-5 mb-3 color-primary">Contests, Sweepstakes, and Promotions</h3>
        ...
        <p>Any contests, sweepstakes, or other promotions (collectively, "Promotions") made available through the
            ...
            review
            the applicable rules as well as our Privacy Policy. If the rules for a Promotion conflict with these Terms,
            the
            Promotion rules will apply.</p>

        <h3 class="mt-5 mb-3 color-primary">Content</h3>
        ...
        <p>By posting Content on or through the Service, you represent and warrant that: (i) the Content is yours (you
            own
            ...
            rights,
            publicity rights, copyrights, contract rights, or any other rights of any person or entity.</p>
    </div>
